        ...
        <tbody>
          {#each data.invites as invite, index}
            <tr>
              ...
              <td class="link-cell">
                <a href={invite.shareLink} title={invite.shareLink}
                  >{invite.token}</a
                >
              </td>
              ...
              <td class="responses">
                ...
                <span class="resp-maybe"
                  >{countStatus(invite.members, "Maybe")}</span
                >
                <span class="resp-no">{countStatus(invite.members, "No")}</span>
                <span class="resp-pending"
                  >{countStatus(invite.members, "NoResponse")}</span
                >
              </td>
              <td>
                <form
              ...
              <td class="actions">
                ...
                >
                  <input type="hidden" name="inviteId" value={invite.id} />
                  <button class="btn-icon" type="submit" title="Remove invite"
                    >×</button
                  >
                </form>
              </td>
